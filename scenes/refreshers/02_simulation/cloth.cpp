...
void scene_model::setup_data(std::map<std::string,GLuint>& shaders, scene_structure& , gui_structure& gui)
{
    ...
    // Load textures
    texture_cloth = create_texture_gpu(image_load_png("scenes/refreshers/02_simulation/assets/cloth.png"));
    texture_wood  = create_texture_gpu(image_load_png("scenes/refreshers/02_simulation/assets/wood.png"));

...
void load_character_data(skeleton_structure& skeleton, skinning_structure& skinning, mesh_drawable& shape_visual, timer_interval& timer, GLuint shader)
{
    ...
    mesh character = mesh_load_file_obj("scenes/refreshers/03_skinning/assets/marine/mesh.obj", vertex_correspondance);

    skeleton.connectivity   = read_skeleton_connectivity("scenes/refreshers/03_skinning/assets/marine/skeleton_connectivity");
    skeleton.rest_pose      = read_skeleton_geometry("scenes/refreshers/03_skinning/assets/marine/skeleton_geometry_local", scaling);
    buffer<buffer<skinning_influence>> influence = read_skinning_influence("scenes/refreshers/03_skinning/assets/marine/skinning_data");
    skinning.influence = map_correspondance(influence, vertex_correspondance);

    // 3 possibles animations:
    // skeleton.anim           = read_skeleton_animation("scenes/refreshers/03_skinning/assets/marine/skeleton_animation_idle", scaling); // t_max = 4.0f
    // skeleton.anim           = read_skeleton_animation("scenes/refreshers/03_skinning/assets/marine/skeleton_animation_walk", scaling); // t_max = 1.0f;
    skeleton.anim           = read_skeleton_animation("scenes/refreshers/03_skinning/assets/marine/skeleton_animation_run", scaling);  // t_max = 0.733f;
    timer.t_max = 0.733f;

    GLuint texture_id = create_texture_gpu(image_load_png("scenes/refreshers/03_skinning/assets/marine/texture.png"));
